...
export function BonsaiTabs({ tabs, value, onValueChange, className }: BonsaiTabsProps) {
  ...
  return (
    <div className={cn('min-w-0 border-b border-border', className)}>
      <div className="overflow-x-auto [-webkit-overflow-scrolling:touch] [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
        ...
        <div
          className="absolute bottom-0 h-[2px] rounded-full bg-primary transition-all duration-300 ease-[cubic-bezier(0.25,0.46,0.45,0.94)]"
