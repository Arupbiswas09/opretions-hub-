...
function buildCommands(): CommandItem[] {
  return [
    ...
    { id: 'nav-contacts', label: 'CRM contacts', icon: Users, category: 'Navigate', href: '/hub/contacts', keywords: ['external', 'crm', 'leads'] },
    ...
    { id: 'nav-people', label: 'Team', icon: UserCircle, category: 'Navigate', href: '/hub/people/directory', keywords: ['internal', 'employees', 'directory', 'hr', 'people'] },
    ...
    { id: 'nav-work', label: 'Work hub', icon: CheckSquare, category: 'Navigate', href: '/hub/work', keywords: ['tasks', 'issues', 'approvals', 'requests', 'board', 'work'] },
    ...
    { id: 'wf-timesheets', label: 'Timesheet approvals (projects)', icon: Inbox, category: 'Workflow', href: '/hub/projects/approvals', keywords: ['approve', 'hours', 'week', 'timesheet'] },
    { id: 'wf-people', label: 'Team & HR approvals', icon: UserCheck, category: 'Workflow', href: '/hub/people/approvals', keywords: ['leave', 'vacation', 'gdpr', 'profile', 'people'] },
