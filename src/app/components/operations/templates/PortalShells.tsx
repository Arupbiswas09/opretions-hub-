...
export function PortalShell({ portalType, children }: PortalShellProps) {
  ...
  return (
    <div className="flex h-screen bg-background text-foreground">
      <div className="hidden md:flex w-64 flex-col border-r border-border bg-[var(--background-2)]">
        <div className="h-16 px-4 flex items-center border-b border-border">
          <div className="flex items-center gap-2">
            ...
            <span className="font-semibold text-foreground">{portalConfig.name}</span>
          </div>
        </div>
        ...
        <div className="p-3 border-t border-border">
          ...
          <button
            type="button"
            className="w-full flex items-center gap-2 px-3 py-2 mt-2 text-sm text-muted-foreground hover:bg-muted rounded-lg transition-colors"
          >
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        <div className="h-16 border-b border-border bg-[var(--background-2)] flex items-center justify-between px-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h2 className="font-semibold text-foreground">Welcome back, John</h2>
        ...
        <div className="flex-1 overflow-auto p-6 bg-background">
          {children || (
            <div className="max-w-6xl mx-auto">
              <div className={cn("bg-gradient-to-r text-white rounded-xl p-6 mb-6 shadow-sm", portalConfig.color)}>
                <h1 className="text-2xl font-semibold mb-1">{portalConfig.name}</h1>
                <p className="text-white/90 text-sm">Your workspace</p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                ...
                <div className="hub-surface hub-surface-elevated rounded-lg p-4">
                  ...
                  <p className="text-2xl font-semibold text-primary mt-1">$12,450</p>
                </div>
              </div>
      ...
      {mobileMenuOpen && (
        <div
          className="fixed inset-0 z-50 md:hidden hub-modal-overlay"
          onClick={() => setMobileMenuOpen(false)}
        >
          <div
            className="w-64 h-full hub-modal-solid border-r border-border"
